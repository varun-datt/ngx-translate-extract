...
export class ServiceParser implements ParserInterface {
	constructor(private readonly serviceName?: string, private readonly serviceMethodNames?: string[]) {
		this.serviceName = serviceName || TRANSLATE_SERVICE_TYPE_REFERENCE;
		this.serviceMethodNames = serviceMethodNames && serviceMethodNames.length ? serviceMethodNames : TRANSLATE_SERVICE_METHOD_NAMES;
	}
